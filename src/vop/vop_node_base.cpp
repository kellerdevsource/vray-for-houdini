...
{
	switch (pluginType)	{
		case VRayPluginType::BRDF: return VOP_VOP_MATERIAL_SHADER;
		case VRayPluginType::MATERIAL: return VOP_VOP_MATERIAL_SHADER;
		case VRayPluginType::TEXTURE: return VOP_VOP_MATERIAL_SHADER;
